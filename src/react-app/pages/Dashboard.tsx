...
import { Local, Reserva, ExtendedMochaUser } from '@/shared/types';
...
export default function Dashboard() {
  ...
  const toggleUserType = async () => {
    try {
      const response = await fetch(`${apiUrl}/api/users/toggle-admin`, {
        method: 'POST',
      });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
                ...
                <div key={local.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        onClick={() => local.id && handleDeleteLocal(local.id)}
          ...
          // Dashboard para Usuários Padrão (Reservas)
          reservas.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Explore nossos locais esportivos e faça sua primeira reserva.
              </p>
              <Link 
                to="/"
                className="inline-flex items-center space-x-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium"
                ...
                <div key={reserva.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <div className="flex justify-between items-start">
                    ...
                    {reserva.status === 'ativa' && (
                      <button
                        onClick={() => reserva.id && handleCancelarReserva(reserva.id)}
